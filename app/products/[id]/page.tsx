    ...
    <div className="max-w-md mx-auto mt-10 mb-20">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 shadow-md rounded-lg text-gray-700">
        ...
        <div className="flex justify-between mt-6">
           ...
           <button type="submit" disabled={loading || imageUploading} className="bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 font-bold disabled:bg-gray-400">
